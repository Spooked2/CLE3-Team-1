...
function createBigDetailArticle(restaurant) {
  ...
  for (const accessibilityFeature of accessibilityFeatures) {
    ...
    switch (accessibilityFeatures.indexOf(accessibilityFeature)) {
      case 0:
        text = "Is er een invalide WC aanwezig?";
        break;
      case 1:
        text = "Op de begaande grond?";
        break;
      case 2:
        text = "Is er een lift aanwezig?";
        break;
      case 3:
        text = "Is er een helling aanwezig?";
        break;
      case 4:
        text = "Wat voor deur is er?";
        break;
      case 5:
        text = "Hoe wijd zijn de deuren?";
        break;
      case 6:
        text = "Hoe wijd zijn de gangpaden?";
        break;
      case 7:
        text = "Hoe ver is de dichtstbijzijnde parkeerplaats?";
        break;
      case 8:
        text = "Hoe ver is de dichtstbijzijnde OV halte?";
        break;
      default:
